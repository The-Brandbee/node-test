          ...
          <div className="Detection-Response-page-middle">
            ...
            <div className="Detection-Response-page-middle-left">
              <p>
                ...
                data from the digital environment. This data was funnelled into
                Security Incident & Event Management (SIEM) systems, an
        ...
        <div className="container">
          ...
          <div className="Eliminate-Complexity-main">
            ...
            <div className="Eliminate-Complexity-main-left">
              <h4>Impact:</h4>
              <p>
                False alarms consumed valuable analyst time, diverting them from
        ...
        <div className="container">
          <div className="Human-Centric-Security-frame-top">
            ...
            <div className="Human-Centric-Security-frame-top-right">
              <p>
                SOC 2.0 represents the evolution of security operations, rooted
                in a human-centric approach that leverages technology to augment
                human capabilities. It acknowledges the dynamic nature of
                multi-cloud and hybrid environments and the constant threat
                posed by adaptable human attackers and their automated tools.
              </p>
            </div>
          </div>
          <div className="Inspired-by-Various-Disciplines">
            <div className="Inspired-by-Various-Disciplines-left">
              ...
              <p>
                <span>Effectiveness (MTTR):</span> Mean Time to Remediate (MTTR)
                measures the speed of risk mitigation.
              </p>
              <p>
              ...
              <p>
                <span>Alert Quality:</span> Focuses on maintaining high-quality
                alert feeds to prevent false positives.
              </p>
            </div>
        ...
        <div className="container">
          <div className="Transforming-Cybersecurity-Investigations-top">
            ...
            <p>
              ...
              Security Operations Center (SOC) represents a significant paradigm
              shift in how we approach and address security challenges. Unlike
              its predecessors, the Modern SOC isn't just about tools and
              processes; it's a holistic transformation in how we investigate
              and respond to security threats, and it promises to be a
              game-changer. Modern SOC is a transformative evolution in security
              operations, emphasizing agility, integration, collaboration,
              visibility, and proactive threat prevention. With its ability to
              respond swiftly to emerging threats, it offers organizations a
              resilient defence against the ever-evolving landscape of cyber
              risks.
            </p>
            <h6>
          ...
          <div className="Transforming-Cybersecurity-Investigations-bottom">
            ...
            <p>
              CSP have developed an end user-integrated system. This can be run
              by our security analysts to prompt workers within Microsoft Teams
              and email and verify if the worker did perform certain activities,
              such as This gives the workforce greater to possibilities to
              engage with the Modern Workplace, while giving the IT team the
              ability to verify and distinguish legitimate and known actions
              from malicious anomolies.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="Benefits-of-mdr-frame-middle-bottom">
              ...
              <div className="Benefits-of-mdr-frame-middle-bottom-left">
                ...
                <p>
                  ...
                  solutions like Microsoft Security Copilot to create a unified
                  and seamless approach to cybersecurity investigations. This
                  integration eliminates the need to jump between multiple
                  tools, simplifying the investigative process and improving
                  efficiency.
                </p>
              </div>
              <div className="Benefits-of-mdr-frame-middle-bottom-left">
                ...
                <p>
                  ...
                  introduces real-time collaboration features, allowing security
                  teams to work together efficiently. This real-time
              ...
              <div className="Benefits-of-mdr-frame-middle-bottom-left">
                ...
                <p>
                  ...
                  organization's security landscape. By consolidating data from
                  various sources, it offers an extensive view of potential
                  threats. This heightened visibility streamlines the
                  identification of security issues, enabling security teams to
